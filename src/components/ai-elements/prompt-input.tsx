...
export const usePromptInputController = () => {
  const value = useContext(Controller)
  if (!value) throw new Error('PromptInputProvider is required')
  return value
}
export const useProviderAttachments = () =>
  usePromptInputController().attachments
...
export const PromptInputProvider = ({
  ...
  const controller = useMemo(
    () => ({
      attachments,
      textInput: { value, setInput, clear: () => setInput('') },
    }),
    [attachments, value]
  )
  return (
...
export const PromptInputBody = (props: HTMLAttributes<HTMLDivElement>) => (
  <div {...props} />
)
...
) => <InputGroupAddon align='block-start' {...props} />
export const PromptInputFooter = (
  props: ComponentProps<typeof InputGroupAddon>
) => <InputGroupAddon align='block-end' {...props} />
...
export const PromptInputSubmit = ({
  ...
  <InputGroupButton
    ...
    {...props}
  >
    {children ?? (status === 'ready' ? <ArrowUpIcon /> : <SquareIcon />)}
  </InputGroupButton>
)
...
export const PromptInputSelect = (props: ComponentProps<typeof Select>) => (
  <Select {...props} />
)
...
export const PromptInputCommand = (props: ComponentProps<typeof Command>) => (
  <Command {...props} />
)
